...
export const TrueFalseAnswerCard = (props) => {
  ...
  return (
    <div className={`
      ...
      grid ${props.value ? 'grid-cols-[auto_min-content] md:grid-cols-[min-content_auto]' : 'grid-cols-[auto_min-content]'}
      ${props.enableOpacity && "opacity-20"}
      overflow-hidden rounded`}>
      <div className={`inline-block w-[90px] p-7
        ${colorClass}
      ...
      <div className={`bg-whiteLight flex justify-center
        ${props.value ? 'row-start-1 col-start-1 col-end-2 md:col-start-2 md:col-end-3' : 'row-start-1 col-start-1 col-end-2'}`}>
